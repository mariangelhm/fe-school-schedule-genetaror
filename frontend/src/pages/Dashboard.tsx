// Panel principal con accesos directos y conteos en vivo alimentados por el store local.
      ...
      <div className="grid gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
          <article className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-800/60">
            <p className="text-sm text-slate-600 dark:text-slate-400">Cursos registrados</p>
